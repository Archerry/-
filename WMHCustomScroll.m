...
+(instancetype)scrollViewWithImageArray:(NSArray *)imageArr pageCtrIsHiden:(BOOL)isHiden ImgType:(NSString *)typeStr{
    WMHCustomScroll *wmhScroll = [[WMHCustomScroll alloc]initWithFrame:CGRectMake(0, 20, allScreen.width, allScreen.width / 2)];
...
-(void)createViewOnScrollView{
    ...
    if (self.isHidePage == NO) {
        ...
        _WMHPageCtr.backgroundColor = [UIColor colorWithRed:0 green:0 blue:0 alpha:0.5];
